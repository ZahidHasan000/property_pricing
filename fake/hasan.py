...
#     location = data['location']
#     # latitude = float(data['latitude'])
#     # latitude = data.get('latitude')  # Get latitude value from JSON data

#     latitude = float(data.get('latitude'))  # Get latitude value from JSON data
#     # Get longitude value from JSON data
#     longitude = float(data.get('longitude'))

#     # Check if latitude and longitude values are valid
#     # if latitude is not None and longitude is not None and \
#     #    isinstance(latitude, (int, float, str)) and \
#     #    isinstance(longitude, (int, float, str)):
#     #     try:
#     #         latitude = float(latitude)
#     #         longitude = float(longitude)
#     #     except ValueError:
#     #         print("Invalid latitude or longitude value:", latitude, longitude)
#     # else:
#     #     print("Missing or invalid latitude or longitude value")
#     #     return jsonify({'error': 'Missing or invalid latitude or longitude value'}), 400
...
#     # if location and latitude and longitude and property_type and option and guests and description and title and base_price and number_of_bedrooms and amenities and seasonality and bathrooms and bed_type and beds and neighborhood and guest_type and request.method == 'POST':
#     # 	# save details
#     #     id = mongo.db.property_price.insert_one({"location": location, "latitude": latitude, "longitude": longitude, "property_type": property_type, "option": option, "guests": guests, "description": description, "title":title, "base_price": base_price, "number_of_bedrooms": number_of_bedrooms, "amenities": amenities, "seasonality": seasonality, "bathrooms": bathrooms, "bed_type": bed_type, "beds": beds, "neighbourhood": neighborhood, "guest_type": guest_type, "sentiment": predicted_price, "prdicted_price": suggested_price, "nearest_price": nearest_price})
#     #     resp = jsonify('Suggested price successfully created!')
#     if location and latitude and longitude and property_type and option and guests and description and title and base_price and number_of_bedrooms and cleaned_amenities and seasonality and bathrooms and bed_type and beds and neighborhood and guest_type and request.method == 'POST':
#         # save details
#         id = mongo.db.property_price.insert_one({"location": location, "latitude": latitude, "longitude": longitude, "property_type": property_type, "option": option, "guests": guests, "description": description, "title": title, "base_price": base_price, "number_of_bedrooms": number_of_bedrooms,
#                                                 "amenities": cleaned_amenities, "seasonality": seasonality, "bathrooms": bathrooms, "bed_type": bed_type, "beds": beds, "neighbourhood": neighborhood, "guest_type": guest_type, "sentiment": predicted_price, "prdicted_price": suggested_price, "nearest_price": nearest_price})
#         resp = jsonify('Suggested price successfully created!')
#         resp.status_code = 200
#         return resp
#     else:
